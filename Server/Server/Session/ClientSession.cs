...
namespace Server
{
    public partial class ClientSession : PacketSession
	{
		...
		public override void OnConnected(EndPoint endPoint)
		{
			...
			{
				MyPlayer = PlayerManager.Instance.AddClientForServer();
				MyPlayer.ObjectInfo.Name = $"Server";
				...
				{
					GameRoom room = GameLogic.Instance.Find(1);
					room.ClientForServer = MyPlayer;
					room.Push(room.EnterGameForServer, MyPlayer);
				});
				return;
			}
